  ...
  return (
    <section className="mx-auto max-w-3xl space-y-6">
      ...
      <p className="text-sm leading-7 text-foreground/90">
        공시딱(이하 &quot;서비스&quot;)은 이용자의 개인정보를 소중하게 생각하며, 관련 법령을 준수합니다.
        본 방침은 서비스 이용 과정에서 수집되는 정보, 이용 목적, 보관 및 파기 기준을 안내합니다.
      </p>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          서비스는 주민등록번호, 계좌번호 등 민감한 금융 개인정보를 수집하지 않습니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          개인정보는 수집 및 이용 목적이 달성되면 지체 없이 파기합니다. 관계 법령에 따라 보관이 필요한 경우,
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          서비스는 원칙적으로 개인정보를 외부에 판매하거나 임의 제공하지 않습니다.
          다만 서비스 운영을 위해 인프라, 인증, 데이터 저장 등 필수 업무가 외부 서비스 제공자를 통해 처리될 수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          이용자는 언제든지 개인정보 조회, 수정, 삭제를 요청할 수 있으며, 계정 삭제를 요청할 수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          개인정보 관련 문의는 아래 이메일로 접수해 주세요: <span className="font-medium">support@gongsittak.com</span>
        </p>
      </section>
    </section>
  );
