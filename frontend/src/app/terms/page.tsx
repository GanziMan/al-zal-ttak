    ...
    <section className="mx-auto max-w-3xl space-y-6">
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          공시딱은 공시 데이터를 기반으로 한 정보 제공 서비스입니다. 서비스에
          포함된 AI 분석, 점수, 코멘트는 투자 참고용 정보이며, 특정 종목
          매수·매도를 권유하지 않습니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          서비스는 데이터 품질 및 안정성 향상을 위해 노력하나, 외부 데이터
          지연·누락·오류 또는 네트워크 장애로 인해 정보 제공이 지연되거나 일부
          부정확할 수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-7 text-foreground/90">
          서비스 품질 개선, 점검, 장애 대응 등을 위해 일부 기능이 변경되거나
          일시 중단될 수 있습니다.
        </p>
      </section>
